...
<div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/PartenaireServlet" class="nav-link text-dark font-italic">
                <i class="fa fa-area-chart mr-3 text-primary fa-fw"></i>
                Partenaire
            </a>
        </li>
        <li class="nav-item">
            <a href="${pageContext.request.contextPath}/CompteServlet" class="nav-link text-dark font-italic">
...
<div class="page-content p-5" id="content">
    ...
    <!-- Demo content -->
    <h2 class="display-4 text-white">BIenvenue dans WARI</h2>
    <p class="lead text-white mb-0">Une présence mondiale, des partenaires de premier plan</p>
    ...
    <div class="row text-white">
        <div class="col-lg-7">
            <p class="lead">Partenaires financiers
            ...
            <div class="bg-white p-5 rounded my-5 shadow-sm">
                <p class="lead font-italic mb-0 text-muted">"Partenaires Commerciaux"</p>
            </div>
            <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
                dolor.
            </p>
